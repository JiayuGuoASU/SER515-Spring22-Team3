...
class Rover:
  ...
  def xacroStr(self):
  	self.xacro = """  <xacro:property name="base_width" value=" """ + str(width) + """ "/>
  <xacro:property name="base_length" value=" """ + str(length) + """ "/>
  <xacro:property name="base_height" value=" """ + str(height) + """ "/>
  """
