      ...
      <world name='default'>
        ...
        <model name='5obstacles'>
          <link name='link_0'>
            ...
            <pose>-1.38701 1.66285 0 0 -0 0</pose>
            <visual name='visual'>
              <pose>0 0 0 0 -0 0</pose>
              <geometry>
                <cylinder>
          ...
          <link name='link_2'>
            ...
            <pose>0.285814 -0.231463 0 0 -0 0</pose>
            <visual name='visual'>
              <pose>0 0 0 0 -0 0</pose>
              <geometry>
                <cylinder>
          ...
          <link name='link_3'>
            ...
            <pose>1.19587 -1.86555 0 0 -0 0</pose>
            <visual name='visual'>
              <pose>0 0 0 0 -0 0</pose>
              <geometry>
                <cylinder>
          ...
          <link name='link_4'>
            ...
            <pose>1.43263 1.78829 0 0 -0 0</pose>
            <visual name='visual'>
              <pose>0 0 0 0 -0 0</pose>
              <geometry>
                <cylinder>
...
sizeint = input("what the size of map you want?(in miters): ")
size = float(sizeint)
print("a " + str(size) + " by " + str(size) + " map is created")
map = Map(size,0)
map.drawmap()